...
class TestDiscoveryTool:
    ...
    def __init__(self) -> None:
        ...
        self.description = "Discover and list tests in the specified path with optional filtering"
        self.parameters = {
            "path": {
                "type": "string",
    ...
    async def _collect_tests(
        ...
        try:
            ...
            raise RuntimeError("Test collection timed out")
        ...
        try:
            if result.stdout.strip():
                ...
                try:
                    ...
                    tests = json.loads(result.stdout) if result.stdout.strip() else []
            else:
                tests = []
            ...
            raise RuntimeError(f"Failed to parse pytest output: {e}")
    ...
    def _format_hierarchy(self, tests: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for file_path, file_data in hierarchy.items():
